...
console.log(z);
//join the two variable using for cocetination
 let fname = "Anoosha"
console.log(fname)
let lname = "Naz"
console.log(fname+ " " +lname)//cocetination
let des: string = "she is so intelligent"//add description
console.log(fname+ " " +lname+ " " +des);

let person: {fname: string, lname: string, age:number}
={fname: "Anosha", lname:"naz", age:18}
console.log(person);
